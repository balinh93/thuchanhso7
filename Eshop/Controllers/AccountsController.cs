    ...
    public class AccountsController : Controller
    {
        ...
        public async Task<IActionResult> ByAddress()
        {
            var lstaccount = from account in _context.Accounts
                             where account.Address.Contains("Tp.Hồ Chí Minh")
                             select account;  
            return View(await lstaccount.ToListAsync());
        }
        public async Task<IActionResult> ByEmail()
        {
            var lstaccount = from account in _context.Accounts
                             where account.Email.Contains("@gmail.com")
                             select account;
            return View(await lstaccount.ToArrayAsync());
        }
    }
}
